...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='state/ssl_gc_referee_message.proto',
  package='',
  syntax='proto2',
  ...
  ,
  dependencies=[state_dot_ssl__gc__game__event__pb2.DESCRIPTOR,])
...
_HULLCOLOR = _descriptor.EnumDescriptor(
  name='HullColor',
  full_name='HullColor',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='HULL_COLOR_UNKNOWN', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HULL_COLOR_DARK', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HULL_COLOR_LIGHT', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_HULLCOLOR)

HullColor = enum_type_wrapper.EnumTypeWrapper(_HULLCOLOR)
UNKNOWN_MATCH = 0
GROUP_PHASE = 1
ELIMINATION_PHASE = 2
FRIENDLY = 3
...
_REFEREE_COMMAND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BALL_PLACEMENT_BLUE', index=17, number=17,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_REFEREE_TEAMINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='goalkeeper', full_name='Referee.TeamInfo.goalkeeper', index=7,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_substitution_intent', full_name='Referee.TeamInfo.bot_substitution_intent', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ball_placement_failures_reached', full_name='Referee.TeamInfo.ball_placement_failures_reached', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_substitution_allowed', full_name='Referee.TeamInfo.bot_substitution_allowed', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_substitutions_left', full_name='Referee.TeamInfo.bot_substitutions_left', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bot_substitution_time_left', full_name='Referee.TeamInfo.bot_substitution_time_left', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hull_color', full_name='Referee.TeamInfo.hull_color', index=17,
...
_REFEREE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='source_identifier', full_name='Referee.source_identifier', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='match_type', full_name='Referee.match_type', index=1,
      number=19, type=14, cpp_type=8, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='packet_timestamp', full_name='Referee.packet_timestamp', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stage', full_name='Referee.stage', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stage_time_left', full_name='Referee.stage_time_left', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='command', full_name='Referee.command', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='command_counter', full_name='Referee.command_counter', index=6,
      number=5, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='command_timestamp', full_name='Referee.command_timestamp', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='yellow', full_name='Referee.yellow', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blue', full_name='Referee.blue', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='designated_position', full_name='Referee.designated_position', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blue_team_on_positive_half', full_name='Referee.blue_team_on_positive_half', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_command', full_name='Referee.next_command', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='game_events', full_name='Referee.game_events', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='game_event_proposals', full_name='Referee.game_event_proposals', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_action_time_remaining', full_name='Referee.current_action_time_remaining', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status_message', full_name='Referee.status_message', index=16,
...
_GAMEEVENTPROPOSALGROUP = _descriptor.Descriptor(
  ...
  full_name='GameEventProposalGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='GameEventProposalGroup.id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='game_events', full_name='GameEventProposalGroup.game_events', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='accepted', full_name='GameEventProposalGroup.accepted', index=2,
...
_REFEREE_TEAMINFO.fields_by_name['hull_color'].enum_type = _HULLCOLOR
...
_REFEREE.fields_by_name['game_events'].message_type = state_dot_ssl__gc__game__event__pb2._GAMEEVENT
...
_GAMEEVENTPROPOSALGROUP.fields_by_name['game_events'].message_type = state_dot_ssl__gc__game__event__pb2._GAMEEVENT
...
DESCRIPTOR.enum_types_by_name['HullColor'] = _HULLCOLOR
...
Referee = _reflection.GeneratedProtocolMessageType('Referee', (_message.Message,), dict(
  ...
  TeamInfo = _reflection.GeneratedProtocolMessageType('TeamInfo', (_message.Message,), dict(
    ...
    __module__ = 'state.ssl_gc_referee_message_pb2'
