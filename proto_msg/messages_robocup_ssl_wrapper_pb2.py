...
_SSL_WRAPPERPACKET = _descriptor.Descriptor(
  ...
  full_name='proto.SSL_WrapperPacket',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='detection', full_name='proto.SSL_WrapperPacket.detection', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='geometry', full_name='proto.SSL_WrapperPacket.geometry', index=1,
